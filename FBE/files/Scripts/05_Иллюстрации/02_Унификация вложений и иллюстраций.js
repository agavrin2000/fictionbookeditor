...
function Run() {
  ...
  $("#binobj DIV #id").each(function (index) {
    ImgInfoNumById[$(this).val().replace(/^fbw-internal:#/i, "")] = index;
  });
  ...
  */
  ...
  if (Tssek < 1 && Tmin < 1) var TimeStr = Tsssek + " с"
    ...
    if (Tsek < 10 && Tmin < 1) var TimeStr = Tssek + " с"
    else {
      if (Tmin < 1) var TimeStr = Tsek + " с"
